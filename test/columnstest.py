...
# Project :zs
# Time  :2019/6/27 下午7:37
str1='''    zsyear = db.Column(db.Integer())  # 总序号
...
descs = []
for field in fields:
    name_temp = field.split("=")
    temp_desc = name_temp[1].split("#")
    names.append(name_temp[0].strip())
    # print(field, temp_desc, name_temp)
    # if len(temp_desc)!=2:
    #
    #     continue
    #
    # name = name_temp[0].strip()
    # desc = temp_desc[1].strip()
    # # print(name,desc)
    #
    #
    # descs.append(desc)
