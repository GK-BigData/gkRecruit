...
class All_Picture():
    ...
    #雷达图--各个学院男女比例占比
    def radar_picture(self,value1,value2):
        ...
        r=(
            ...
            .add_schema(
                schema=[
                    opts.RadarIndicatorItem(name="计算机工程技术学院",max_=3000),
                    opts.RadarIndicatorItem(name="商学院", max_=3000),
                    opts.RadarIndicatorItem(name="外贸与旅游学院", max_=3000),
                    opts.RadarIndicatorItem(name="人文社会科学学院", max_=3000),
                    opts.RadarIndicatorItem(name="机器人学院", max_=3000),
                    opts.RadarIndicatorItem(name="机械与汽车学院", max_=3000),
                    opts.RadarIndicatorItem(name="建筑工程学院", max_=3000),
                    opts.RadarIndicatorItem(name="艺术设计学院", max_=3000),
                    opts.RadarIndicatorItem(name="财会与金融学院", max_=3000),
                    opts.RadarIndicatorItem(name="体育系", max_=3000),
                    opts.RadarIndicatorItem(name="广州学院", max_=3000),
                ]
            )
            .add("男",v1)
            .add("女",v2)
