...
# 字段的规则
needcolumns_pattern=['*', 'education_number', '^[男|女]$', 'id_card', 'total_score_of_filing', 'ranking', 'major_name', 'report', 'report_for_cancel', 'student_address', 'graduation_secondary_school_name', '.*族', 'political_appearance_name', 'student_type', 'departments', 'education__time', 'source_provinces', 'offer_volunteer', 'Professional_1', 'Professional_2', 'Professional_3', 'Professional_4', 'Professional_5', 'Professional_6']
